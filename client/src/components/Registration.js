import { Avatar, FormControl, FormControlLabel, FormLabel, Grid, Paper, Radio, RadioGroup, TextField, Typography } from '@mui/material';
    ...
    <Grid align='center' marginTop='70px'>
        <Paper elevation={20} style={paperStyle} >
            <Grid align='center'>
                ...
                <Typography varient='caption'>Please fill this form for buying and selling !</Typography> 
    </Grid>
