          ...
          alignItems: 'center',
            ...
            >
                ...
                >
                    ...
                    >
                    <Typography variant="h2"  >Operations in the chemical manufacturing sector include: Basic chemicals facilities produce chemicals by basic processes, such as thermal cracking and distillation.</Typography>
            ...
            >
              ...
              <TextField  id="outlined-start-adornment" variant="outlined" fullWidth required
              sx={{
                background:'white'
              }}/>
              ...
              >
                ...
                <TextField   id="outlined-start-adornment" type="password" variant="outlined" fullWidth required
                sx={{
                background:'white'
              }}
                />
